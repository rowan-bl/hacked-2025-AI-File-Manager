...
4. **Setting up the backend**: create a file called .env within the backend folder  **Inside the .env should be**: `OLLAMA_URL=http://localhost:11434/api/generate`\ `MODEL=deepseek-r1:8b`
